...
<body class="overflow-x-hidden">
    <canvas id="screen" class="absolute"></canvas>
    <main class="flex flex-col gap-16 justify-center items-center min-h-screen bg-[#232f3e] md:gap-8">
        <!-- <img src="/quizz/assets/images/aws.png" alt="" class="z-10 object-contain w-1/2 md:w-1/5"> -->
        <form method="POST" class="z-10 flex flex-col gap-4 bg-white rounded-xl p-4 w-10/12 sm:w-3/4 md:w-2/5 lg:w-2/5">
    ...
    <script src="/quizz/app/js/screen.js"></script>
</body>
